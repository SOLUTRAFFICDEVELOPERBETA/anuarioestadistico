...
import { Avatar, makeStyles, Popover, List, ListItem, ListItemText, Button, ListItemIcon } from '@material-ui/core'
    ...
    <React.Fragment>
      {auth ? (
        <Button
          ...
          onClick={handleClick}
          endIcon={
            <Avatar className={classes.avatar} alt="img-user" src={user && user.avatar ? user.avatar.url : PROFILE_IMG} />
          }
        >
          {moment().format('ll')}
        </Button>
