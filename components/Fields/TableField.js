          ...
          <Box padding={1}>
            <ButtonGroup size="small" variant="text">
              <Tooltip title="Color de texto">
                <ColorPick icon={FormatColorTextTwoTone} color={textColor} onChange={(color) => handleColorChange('textColor', color)} />
              </Tooltip>
              <Tooltip title="Color de celda">
                <ColorPick icon={FormatColorFillTwoTone} color={cellColor} onChange={(color) => handleColorChange('cellColor', color)} />
              </Tooltip>
