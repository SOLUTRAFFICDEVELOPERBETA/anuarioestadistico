...
// Método para cambiar el tipo de orden de la tabla. es asc  desc
                ...
                {headCells.map((headCell) => (
                    <TableCell
                        ...
                        <TableSortLabel
                            ...
                            {headCell.label}
                            {orderBy === headCell.id ? (
                                <span className={classes.visuallyHidden}>{order}</span>
                            ) : null}
                        </TableSortLabel>
                    </TableCell>
                ))}
...
const DocumentsTable = ({ documents, onDelete }) => {
    ...
    const handleSearch = ({ search }) => {
        const array = [...documents].filter((c) =>
                                            ...
                                            <TableCell scope="row" align="center" padding="none">
                                                ...
                                                <Tooltip title="Abrir" arrow>
                                                    <IconButton
                                                        ...
                                                        onClick={() =>
                                                            router.push(
                                                                '/paginas/createPages/[id]',
                                                                `/paginas/createPages/${row.id}`
                                                            )
                                                        }>
